...
% Example equation reference: As shown in eqn. (3.1), the accuracy improves significantly.

\subsubsection{Result 1}

\textbf{[TODO: Add first set of results here]}

For example, the accuracy can be calculated using eqn. (\ref{eq:accuracy}).
